                    ...
                    <div className="review__wrapper">
                      ...
                      <h4>Leave your experience</h4>
                        <form action="" onSubmit={submitHandler}>
                          ...
                          <div className="form__group">
                            <textarea ref={reviewMsg} rows={4} type="text" placeholder='Add Your Review' required />
                          </div>
                          <motion.button whileTap={{scale: 1.2}} type='submit' style={{color: "white"}} className="buy__btn">Submit</motion.button>
